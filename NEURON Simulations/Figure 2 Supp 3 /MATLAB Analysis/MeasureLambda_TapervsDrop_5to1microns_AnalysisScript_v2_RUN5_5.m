...
[lambda_t_g0001, resp_peak_t_g0001] = calc_lambda('Full Taper/g0001', 2);
[lambda_t_g0002, resp_peak_t_g0002] = calc_lambda('Full Taper/g0002', 3);
[lambda_t_g00005, resp_peak_t_g00005] = calc_lambda('Full Taper/g00005', 2);
[lambda_t_g000067, resp_peak_t_g000067] = calc_lambda('Full Taper/g000067', 2);

[lambda_d01_g0001, resp_peak_d01_g0001] = calc_lambda('drop 0.1 to 0.9/g0001', 2);
[lambda_d01_g0002, resp_peak_d01_g0002] = calc_lambda('drop 0.1 to 0.9/g0002', 3);
[lambda_d01_g00005, resp_peak_d01_g00005] = calc_lambda('drop 0.1 to 0.9/g00005', 2);
[lambda_d01_g000067, resp_peak_d01_g000067] = calc_lambda('drop 0.1 to 0.9/g000067', 2);

[lambda_d02_g0001, resp_peak_d02_g0001] = calc_lambda('drop 0.2 to 0.8/g0001', 2);
[lambda_d02_g0002, resp_peak_d02_g0002] = calc_lambda('drop 0.2 to 0.8/g0002', 3);
[lambda_d02_g00005, resp_peak_d02_g00005] = calc_lambda('drop 0.2 to 0.8/g00005', 2);
[lambda_d02_g000067, resp_peak_d02_g000067] = calc_lambda('drop 0.2 to 0.8/g000067', 2);

[lambda_d03_g0001, resp_peak_d03_g0001] = calc_lambda('drop 0.3 to 0.7/g0001', 2);
[lambda_d03_g0002, resp_peak_d03_g0002] = calc_lambda('drop 0.3 to 0.7/g0002', 3);
[lambda_d03_g00005, resp_peak_d03_g00005] = calc_lambda('drop 0.3 to 0.7/g00005', 2);
[lambda_d03_g000067, resp_peak_d03_g000067] = calc_lambda('drop 0.3 to 0.7/g000067', 2);

[lambda_d04_g0001, resp_peak_d04_g0001] = calc_lambda('drop 0.4 to 0.6/g0001', 2);
[lambda_d04_g0002, resp_peak_d04_g0002] = calc_lambda('drop 0.4 to 0.6/g0002', 3);
[lambda_d04_g00005, resp_peak_d04_g00005] = calc_lambda('drop 0.4 to 0.6/g00005', 2);
[lambda_d04_g000067, resp_peak_d04_g000067] = calc_lambda('drop 0.4 to 0.6/g000067', 2);


[lambda_d045_g0001, resp_peak_d045_g0001] = calc_lambda('drop 0.45 to 0.55/g0001', 2);
[lambda_d045_g0002, resp_peak_d045_g0002] = calc_lambda('drop 0.45 to 0.55/g0002', 3);
[lambda_d045_g00005, resp_peak_d045_g00005] = calc_lambda('drop 0.45 to 0.55/g00005', 2);
[lambda_d045_g000067, resp_peak_d045_g000067] = calc_lambda('drop 0.45 to 0.55/g000067', 2);
