% RUN 2 Lambda Measurements for Subset of Drop-off and Tapered Neurites
% 11 Dec 2018
...
for i = 1:length(Ra_short_vect)
    ...
    plot([0 300], [1000 1000], 'k-', 'LineWidth', 1)
    box off; ylim([0 10]); xlim([0 1000]); ylabel('Response (mV)', 'Fontsize', 12); xlabel('Distance (microns)','Fontsize', 12);set(gca,'FontSize',12)
