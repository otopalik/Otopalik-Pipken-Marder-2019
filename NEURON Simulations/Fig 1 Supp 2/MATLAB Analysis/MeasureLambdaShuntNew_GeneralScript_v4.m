...
for i = 1:25
    ...
    plot(dist_vect, resp_peak_100um(:,i), '.-', 'MarkerSize', 10, 'LineWidth', 1); hold on
    ...
    ylim([0 10]); ylabel('Response (mV)'); xlabel('Distance (um)')
    box off; hold on;
end
legend('Shunt = 100um', 'Shunt = 300um', 'Shunt = 500um', 'Shunt = 1mm', 'Shunt = 5mm', 'Shunt = 10mm')
